...
Var UndefinedSampleSource         : Array[0..30] Of String;
    ...
    ColorReservedWord            : TColor = clBlue;
    ColorString                  : TColor = clRed;
    ColorSymbol                  : TColor = clMaroon;
    ColorFunction                : TColor = clSkyBlue;
...
procedure CreateDefaultSwiftAttribs;
Begin
 //Comments
 SetAttributeOn(SwiftIdx, 0, clNone, ColorComment, [fsItalic]);
 //DataType
 SetAttributeOn(SwiftIdx, 1, clNone, MainForeground, [fsBold]);
 //Numbers
 SetAttributeOn(SwiftIdx, 5, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(SwiftIdx, 6, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(SwiftIdx, 8, clNone, ColorString, []);
 //Symbol
 //SetAttributeOn(RIdx, 10, clNone, ColorSymbol, []);
 //Preprocessor
 //SetAttributeOn(RIdx, 6, clNone, ColorPreProcessor, []);
...
procedure CreateDefaultDartAttribs;
Begin
 //Annotations
 SetAttributeOn(DartIdx, 0, clNone, ColorComment, []);
 //Comments
 SetAttributeOn(DartIdx, 1, clNone, ColorComment, [fsItalic]);
 //DataType
 SetAttributeOn(DartIdx, 2, clNone, MainForeground, [fsBold]);
 //Numbers
 SetAttributeOn(DartIdx, 6, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(DartIdx, 8, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(DartIdx, 10, clNone, ColorString, []);
 //Symbol
 //SetAttributeOn(RIdx, 10, clNone, ColorSymbol, []);
 //Preprocessor
 SetAttributeOn(DartIdx, 7, clNone, ColorPreProcessor, []);

 CommTmp.CommentType := CommentTypeMultiLine;
 CommTmp.LanguageID := DartIdx;
 CommTmp.SingleLineID := '//';
 CommTmp.MultiLineIDStart := '/*';
 CommTmp.MultiLineIDEnd := '*/';
...
procedure CreateDefaultAutoItAttribs;
Begin
 //Annotations
 SetAttributeOn(AutoItIdx, 0, clNone, ColorComment, []);
 //Comments
 SetAttributeOn(AutoItIdx, 1, clNone, ColorComment, [fsItalic]);
 //DataType
 //SetAttributeOn(DartIdx, 2, clNone, MainForeground, [fsBold]);
 //Functions
 SetAttributeOn(AutoItIdx, 3, clNone, clNone, [fsBold]);
 //Macro
 SetAttributeOn(AutoItIdx, 5, clNone, clNone, [fsItalic]);
 //Numbers
 SetAttributeOn(AutoItIdx, 6, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(AutoItIdx, 8, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(AutoItIdx, 10, clNone, ColorString, []);
 //Symbol
 SetAttributeOn(AutoItIdx, 11, clNone, ColorSymbol, []);
 //Preprocessor
 SetAttributeOn(AutoItIdx, 7, clNone, ColorPreProcessor, []);

 CommTmp.CommentType := CommentTypeMultiLine;
 CommTmp.LanguageID := AutoItIdx;
 CommTmp.SingleLineID := ';';
 CommTmp.MultiLineIDStart := '#cs';
 CommTmp.MultiLineIDEnd := '#ce';

 CommentDataListAdd(CommTmp);
end;

procedure CreateDefaultErlangAttribs;
Begin
 //Comments
 SetAttributeOn(ErlangIdx, 0, clNone, ColorComment, [fsItalic]);
 //DataType
 //SetAttributeOn(DartIdx, 2, clNone, MainForeground, [fsBold]);
 //Functions
 SetAttributeOn(ErlangIdx, 3, clNone, clNone, [fsBold]);
 //Macro
 //SetAttributeOn(ErlangIdx, 5, clNone, clNone, [fsItalic]);
 //Numbers
 SetAttributeOn(ErlangIdx, 5, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(ErlangIdx, 7, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(ErlangIdx, 9, clNone, ColorString, []);
 //Symbol
 SetAttributeOn(ErlangIdx, 10, clNone, ColorSymbol, []);
 //Pragma
 SetAttributeOn(ErlangIdx, 6, clNone, ColorPreProcessor, []);

 CommTmp.CommentType := CommentTypeSingleLine;
 CommTmp.LanguageID := ErlangIdx;
 CommTmp.SingleLineID := '%';
 CommTmp.MultiLineIDStart := '';
 CommTmp.MultiLineIDEnd := '';
...
procedure CreateDefaultProtoBufAttribs;
Begin
 //Comments
 SetAttributeOn(ProtoBufIdx, 0, clNone, ColorComment, [fsItalic]);
 //DataType
 SetAttributeOn(ProtoBufIdx, 1, clNone, MainForeground, [fsBold]);
 //Numbers
 SetAttributeOn(ProtoBufIdx, 5, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(ProtoBufIdx, 6, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(ProtoBufIdx, 8, clNone, ColorString, []);
 //Symbol
 //SetAttributeOn(RIdx, 10, clNone, ColorSymbol, []);
 //Preprocessor
 //SetAttributeOn(RIdx, 6, clNone, ColorPreProcessor, []);
 ...
 CommTmp.CommentType := CommentTypeMultiLine;
 CommTmp.LanguageID := ProtoBufIdx;
 CommTmp.SingleLineID := '//';
 CommTmp.MultiLineIDStart := '/*';
 CommTmp.MultiLineIDEnd := '*/';
...
procedure CreateDefaultKotlinAttribs;
Begin
 //Comments
 SetAttributeOn(KotlinIdx, 0, clNone, ColorComment, [fsItalic]);
 //DataType
 SetAttributeOn(KotlinIdx, 1, clNone, MainForeground, [fsBold]);
 //Numbers
 SetAttributeOn(KotlinIdx, 5, clNone, ColorNumber, []);
 //Reserved Word
 SetAttributeOn(KotlinIdx, 6, clNone, ColorReservedWord, [fsBold]);
 //String
 SetAttributeOn(KotlinIdx, 8, clNone, ColorString, []);
 //Symbol
 //SetAttributeOn(RIdx, 10, clNone, ColorSymbol, []);
 //Preprocessor
 //SetAttributeOn(RIdx, 6, clNone, ColorPreProcessor, []);
...
begin
 ...
 CreateDefaultSwiftAttribs;
 CreateDefaultDartAttribs;
 CreateDefaultAutoItAttribs;
 CreateDefaultErlangAttribs;
 CreateDefaultProtoBufAttribs;
 CreateDefaultKotlinAttribs;
end;
 ...
 For I := 0 To WSynList.Count - 1 Do
  For A := 0 To WSynList[I].AttrCount - 1 Do
   Begin
    ...
    If WSynList[I].Attribute[A].StoredName = SYNS_AttrFunction Then
     WSynList[I].Attribute[A].Foreground := MainForeground;

    If WSynList[I].Attribute[A].StoredName = SYNS_AttrDataType Then
     WSynList[I].Attribute[A].Foreground := MainForeground;

    If WSynList[I].Attribute[A].StoredName = SYNS_AttrPragma Then
     WSynList[I].Attribute[A].Foreground := ColorPreProcessor;
   end;
end;
