...
begin
 ...
 R.Name := 'Into The Blue';
 R.IsInternal := True;
 R.MainForeground := RgbToColor(0, 93, 252);
 R.MainBackground := RgbToColor(0, 20, 127);
 R.ColorComment := RgbToColor(107, 71, 5);
 R.ColorNumber := RgbToColor(235, 235, 235);
 R.ColorPreProcessor := RgbToColor(193, 193, 193);
 R.ColorReservedWord := RgbToColor(129, 129, 129);
 R.ColorString := RgbToColor(0, 188, 189);
 R.ColorSymbol := RgbToColor(129, 129, 129);
 R.LineForeground := clNone;
 R.LineBackground := RgbToColor(0, 21, 222);
 ...
 R.Name := 'Snow Walker';
 R.IsInternal := True;
 R.MainForeground := RgbToColor(0, 154, 27);
 R.MainBackground := RgbToColor(255, 255, 255);
 R.ColorComment := RgbToColor(129, 129, 129);
 R.ColorNumber := RgbToColor(0, 93, 252);
 R.ColorPreProcessor := RgbToColor(0, 20, 127);
 R.ColorReservedWord := clBlack;
 R.ColorString := RgbToColor(246, 115, 4);
 R.ColorSymbol := clBlack;
 R.LineForeground := clNone;
 R.LineBackground := RgbToColor(33, 33, 33);
